...
const RetailPage: React.FC = () => {
  const backgroundImageUrl = "https://images.unsplash.com/photo-1528698827591-e19ccd73353d?q=80&w=2070&auto=format&fit=crop";
        ...
        <div className="relative z-10 p-8 sm:p-12 lg:p-16">
          <div className="bg-white/90 backdrop-blur-sm p-8 sm:p-10 md:p-12 rounded-2xl max-w-2xl shadow-xl">
            ...
            <p className="mt-6 text-base md:text-lg text-gray-600 max-w-xl mx-auto">
              We are working hard to bring you a dedicated page for the Retail sector. Please check back later for exciting updates and specialized service information.
            </p>
